...
public class Task41 {
    public static void main(String[] args) {
        System.out.println("Task41.1: "+ Arrays.toString(encrypt("Hello")));
        System.out.println("Task41.2: "+ decrypt(new int[] {72,29,7,0,3}));
        System.out.println("Task42: " + canMove("rook", "A1", "C1"));
        System.out.println("Task43: " + canComplete("mas", "masseffect"));
        System.out.println("Task44: " +sumDigitProd(new int[] {16,21,10}));
        System.out.println("Task45: " +sameVowelGroup(new String[] {"vae","eav", "value"}));
        System.out.println("Task46: " +validateCard(1234567890123452L));
        System.out.println("Task47.1: " +numToEng(129));
        System.out.println("Task47.2: " +numToRus(129));
        System.out.println("Task48: " +getSha256Hash("Mama Ya ne Hochu Umirat"));
        System.out.println("Task49: " +correctTitle("jOn Snow, King IN thE noRth."));
        System.out.println("Task50: \n" +hexLattice(7));
    }
